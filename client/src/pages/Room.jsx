...
const Room = ({ match }) => {
    ...
    const onDateSelect = (value) => {
        ...
        console.log('value normalized', checkinDate, checkoutDate)
                ...
                <Space direction="vertical" size={12}>
                    <RangePicker
                        ...
                        disabledDate={current => {
                            ...
                            console.log('disable dates current:', current.format('YYYY-MM-DD HH:mm z'), 'start', moment(bookings[0].bookingStart).format('YYYY-MM-DD HH:mm z'))
                            return (bookings.findIndex(booking => moment(currentWithoutTime).isBetween(booking.bookingStart, booking.bookingEnd)
                                ||
                                moment(currentWithoutTime).isSame(booking.bookingStart)
                                ...
                                ||
                                moment(currentWithoutTime).isBefore(moment().subtract(1, 'days'))//disable dates before today
                        }}
                    />
                    <p> {dateError}</p>
